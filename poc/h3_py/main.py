...
for area, group in grouped_addresses:
    ...
    if num_data_points == 1:
        ...
        feature = geojson.Feature(geometry=create_geojson_point(point_coord), properties={'Area': area})
        ...
        feature = geojson.Feature(geometry=geojson.MultiPolygon(polygons), properties={'Area': area})
        area_geojson["features"].append(feature)
